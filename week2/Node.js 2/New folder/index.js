...
// this conditional statment for:
// if there is an environment filename what ever is't & it's not exist >. create new file
// function isExist(fileName) {
//   let truthy = false
//   filesReader(fileName).then(data => {
//     if (data) {
//       truthy = true
//     }
//   }).catch(err => {
//     if (err === ENOENT) {
//       filesWriter(process.env.todosFileName).catch(e => { console.error(e) })
//     }
//   })
// }

// if (process.env.todosFileName) {

// }

// if (process.env.todosFileName && isExist(process.env.todosFileName)) {
//   console.log("here")
//   filesWriter(process.env.todosFileName)
// }

// filesReader(process.env.todosFileName).then(data => {
//   console.log("readed")
// }).catch(e => {
//   console.log(e)
//   })
...
// }
// console.log(process.env.todosFileName)
...
// filesReader(FILE_NAME).catch(err)
